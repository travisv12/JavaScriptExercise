...
const picArray = [
 ...
 const section = document.getElementById('pictures');
        ...
        function createArticle(pic) {
            const article = document.createElement('article');
            article.classList.add('card');
            // Set onclick attribute for the entire article
            article.onclick = function() {
                openModal(pic.image.large);
            };
        ...
        // Function to open modal and set modal image
        ...
        // Populate articles from picArray
